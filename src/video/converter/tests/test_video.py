...
from video.converter.browser.widget import MediaStream

from video.converter.testing import (
...
from video.converter.tests import getVideoBlob, test_file_dir
...
class VideoIntegrationTest(unittest.TestCase):
    ...
    def getFti(self):
        return queryUtility(IDexterityFTI, name='Video')

    def create(self, id):
        self.portal.invokeFactory('Video', id,
    ...
    def test_schema(self):
        ...
        self.assertEqual(schema.getName(), 'plone_0_Video')
